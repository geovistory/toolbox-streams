...
REPARTITIONED_E_BY_PK_SINK(REPARTITIONED_E_BY_PK_SINK) --> ts_el4_e_repartitioned[ts_el4_e_repartitioned]
ts.projects.info_proj_rel[ts.projects.info_proj_rel] --> ts.projects.info_proj_rel-source(ts.projects.info_proj_rel-<br>source)
REPARTITIONED_IPR_BY_FKE_SINK(REPARTITIONED_IPR_BY_FKE_SINK) --> ts_el4_ipr_repartitioned[ts_el4_ipr_repartitioned]
...
REPARTITIONED_S_BY_PK_SINK(REPARTITIONED_S_BY_PK_SINK) --> ts_el4_s_repartitioned[ts_el4_s_repartitioned]
ts_el4_ipr_repartitioned[ts_el4_ipr_repartitioned] --> REPARTITIONED_IPR_BY_FKE_SOURCE(REPARTITIONED_IPR_BY_FKE_SOURCE)
e-store[(e-<br>store)] --> JOIN_IPR(JOIN_IPR)
s-store[(s-<br>store)] --> JOIN_IPR(JOIN_IPR)
ipr-store[(ipr-<br>store)] --> JOIN_IPR(JOIN_IPR)
ts_el4_s_repartitioned[ts_el4_s_repartitioned] --> REPARTITIONED_S_BY_PK_SOURCE(REPARTITIONED_S_BY_PK_SOURCE)
s-store[(s-<br>store)] --> JOIN_S(JOIN_S)
ipr-store[(ipr-<br>store)] --> JOIN_S(JOIN_S)
ts_el4_e_repartitioned[ts_el4_e_repartitioned] --> REPARTITIONED_E_BY_PK_SOURCE(REPARTITIONED_E_BY_PK_SOURCE)
e-store[(e-<br>store)] --> JOIN_E(JOIN_E)
ipr-store[(ipr-<br>store)] --> JOIN_E(JOIN_E)
PROJECT_ENTITY_SINK(PROJECT_ENTITY_SINK) --> ts_el4_project_entity[ts_el4_project_entity]
PROJECT_STATEMENT_REPARTITIONED_BY_OB_SINK(PROJECT_STATEMENT_REPARTITIONED_BY_OB_SINK) --> ts_el4_project_statement_repartitioned_by_object[ts_el4_project_statement_repartitioned_by_object]
PROJECT_STATEMENT_REPARTITIONED_BY_SUB_SINK(PROJECT_STATEMENT_REPARTITIONED_BY_SUB_SINK) --> ts_el4_project_statement_repartitioned_by_subject[ts_el4_project_statement_repartitioned_by_subject]
ts_el4_project_entity[ts_el4_project_entity] --> PROJECT_ENTITY_SOURCE(PROJECT_ENTITY_SOURCE)
STOCK_PE(STOCK_PE) --> pe-store[(pe-<br>store)]
ts_el4_project_statement_repartitioned_by_subject[ts_el4_project_statement_repartitioned_by_subject] --> PROJECT_STATEMENT_REPARTITIONED_BY_SUB_SOURCE(PROJECT_STATEMENT_REPARTITIONED_BY_SUB_SOURCE)
...
ts_el4_project_statement_repartitioned_by_object[ts_el4_project_statement_repartitioned_by_object] --> PROJECT_STATEMENT_REPARTITIONED_BY_OB_SOURCE(PROJECT_STATEMENT_REPARTITIONED_BY_OB_SOURCE)
...
PROJECT_EDGE_LITERALS_SINK(PROJECT_EDGE_LITERALS_SINK) --> ts_el4_project_edges[ts_el4_project_edges]
PROJECT_S_OB_BY_PK_SINK(PROJECT_S_OB_BY_PK_SINK) --> ts_el4_project_statement_with_ob_by_pk[ts_el4_project_statement_with_ob_by_pk]
PROJECT_S_SUB_BY_PK_SINK(PROJECT_S_SUB_BY_PK_SINK) --> ts_el4_project_statement_with_sub_by_pk[ts_el4_project_statement_with_sub_by_pk]
...
ts_el4_ipr_repartitioned
ts_el4_s_repartitioned
ts_el4_e_repartitioned
ts_el4_project_entity
ts_el4_project_statement_repartitioned_by_subject
ts_el4_project_statement_repartitioned_by_object
ts_el4_project_statement_with_ob_by_pk
ts_el4_project_statement_with_sub_by_pk
ts_el4_e_repartitioned
ts_el4_ipr_repartitioned
ts_el4_s_repartitioned
ts_el4_project_entity
