...
public class SinkNames {
    ...
    public static final String PUBLIC_PROJECT_EDGE_SINK = "PUBLIC_PROJECT_EDGE_SINK";
    public static final String TOOLBOX_PROJECT_EDGE_SINK = "TOOLBOX_PROJECT_EDGE_SINK";
