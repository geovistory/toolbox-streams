...
public class SinkNames {
    ...
    public static final String PROJECT_EDGE_PUBLIC_SINK = "PROJECT_EDGE_PUBLIC_SINK";
    public static final String PROJECT_EDGE_TOOLBOX_SINK = "PROJECT_EDGE_TOOLBOX_SINK";
    ...
    public static final String COMMUNITY_EDGE_TOOLBOX_SINK = "COMMUNITY_EDGE_TOOLBOX_SINK";
    public static final String COMMUNITY_EDGE_PUBLIC_SINK = "COMMUNITY_EDGE_PUBLIC_SINK";
