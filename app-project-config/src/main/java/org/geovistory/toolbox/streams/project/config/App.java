...
import static org.geovistory.toolbox.streams.project.config.BuildProperties.getDockerImageTag;
import static org.geovistory.toolbox.streams.project.config.BuildProperties.getDockerTagSuffix;
...
class App {
    ...
    private static void addSubTopologies(StreamsBuilder builder) {
        ...
        var outputTopics = new RegisterInnerTopic(builder);
        ...
        var ontomeClassLabelStream = inputTopics.ontomeClassLabelStream();
