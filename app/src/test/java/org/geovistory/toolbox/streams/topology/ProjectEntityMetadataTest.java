...
import org.geovistory.toolbox.streams.topologies.ProjectEntityClassMetadata;
...
class ProjectEntityMetadataTest {

    private static final String SCHEMA_REGISTRY_SCOPE = ProjectEntityMetadataTest.class.getName();
