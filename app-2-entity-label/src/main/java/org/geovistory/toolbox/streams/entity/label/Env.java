...
public enum Env {
    ...
    public final String TOPIC_COMMUNITY_ENTITY_LABEL_CONFIG;
    ...
    Env() {
        ...
        this.TOPIC_COMMUNITY_ENTITY_LABEL_CONFIG = Utils.coalesce(
                System.getProperty("TS_TOPIC_COMMUNITY_ENTITY_LABEL_CONFIG"),
                System.getenv("TS_TOPIC_COMMUNITY_ENTITY_LABEL_CONFIG"),
                dotenv.get("TS_TOPIC_COMMUNITY_ENTITY_LABEL_CONFIG"),
