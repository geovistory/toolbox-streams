...
class CommunityToolboxStatementWithEntityTest {
    ...
    void setup() {
        ...
        var communityToolboxStatementWithEntity = new CommunityToolboxStatementWithEntity(avroSerdes, registerInputTopic, registerInnerTopic, outputTopicNames);
        communityToolboxStatementWithEntity.addProcessorsStandalone();
