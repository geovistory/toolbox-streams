```mermaid
graph TD
ts_3el3_label_edge_by_source[ts_3el3_label_edge_by_source] --> SOURCE_LABEL_EDGE_BY_SOURCE(SOURCE_LABEL_EDGE_BY_SOURCE)
...
ts_3el3_entity_labels[ts_3el3_entity_labels] --> SOURCE_LABEL(SOURCE_LABEL)
ts_3el3_label_edge_by_target[ts_3el3_label_edge_by_target] --> SOURCE_LABEL_EDGE_BY_TARGET(SOURCE_LABEL_EDGE_BY_TARGET)
...
SINK_ENTITY_LABEL(SINK_ENTITY_LABEL) --> ts_3el3_entity_labels[ts_3el3_entity_labels]
SINK_ENTITY_LANG_LABELS(SINK_ENTITY_LANG_LABELS) --> ts_3el3_entity_language_labels[ts_3el3_entity_language_labels]
SINK_LABEL_EDGE_BY_SOURCE(SINK_LABEL_EDGE_BY_SOURCE) --> ts_3el3_label_edge_by_source[ts_3el3_label_edge_by_source]
SINK_LABEL_EDGE_BY_TARGET(SINK_LABEL_EDGE_BY_TARGET) --> ts_3el3_label_edge_by_target[ts_3el3_label_edge_by_target]
ts.projects.entity_label_config[ts.projects.entity_label_config] --> SOURCE_LABEL_CONFIG(SOURCE_LABEL_CONFIG)
SINK_LABEL_CONFIG_BY_PROJECT_CLASS_KEY(SINK_LABEL_CONFIG_BY_PROJECT_CLASS_KEY) --> ts_3el3_label_config_by_project_class_key[ts_3el3_label_config_by_project_class_key]
ts_3el3_label_config_by_project_class_key[ts_3el3_label_config_by_project_class_key] --> SOURCE_LABEL_CONFIG_BY_CLASS_KEY(SOURCE_LABEL_CONFIG_BY_CLASS_KEY)
...
ts_3el3_label_edge_by_source
ts_p_items_project_edges
ts_3el3_entity_labels
ts_3el3_label_edge_by_target
ts.projects.entity_label_config
ts_3el3_label_config_by_project_class_key
ts_3el3_entity_labels
ts_3el3_entity_language_labels
ts_3el3_label_edge_by_source
ts_3el3_label_edge_by_target
ts_3el3_label_config_by_project_class_key
