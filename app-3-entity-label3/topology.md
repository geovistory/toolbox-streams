```mermaid
graph TD
ts_el_6_label_edge_by_source[ts_el_6_label_edge_by_source] --> SOURCE_LABEL_EDGE_BY_SOURCE(SOURCE_LABEL_EDGE_BY_SOURCE)
UPDATE_LABEL_EDGES_BY_SOURCE_STORE(UPDATE_LABEL_EDGES_BY_SOURCE_STORE) --> label-edge-sort-key-store[(label-<br>edge-<br>sort-<br>key-<br>store)]
...
ts_p_items_6_toolbox_project_edges[ts_p_items_6_toolbox_project_edges] --> SOURCE_EDGE(SOURCE_EDGE)
ts_el_6_entity_labels[ts_el_6_entity_labels] --> SOURCE_LABEL(SOURCE_LABEL)
ts_el_6_label_edge_by_target[ts_el_6_label_edge_by_target] --> SOURCE_LABEL_EDGE_BY_TARGET(SOURCE_LABEL_EDGE_BY_TARGET)
...
ENTITY_LABEL_TOOLBOX_PROJECT(ENTITY_LABEL_TOOLBOX_PROJECT) --> ts_el_6_entity_labels_toolbox_project[ts_el_6_entity_labels_toolbox_project]
SINK_EDGES_TOOLBOX_COMMUNITY(SINK_EDGES_TOOLBOX_COMMUNITY) --> ts_el_6_label_edges_toolbox_community_by_source[ts_el_6_label_edges_toolbox_community_by_source]
SINK_ENTITY_LABEL(SINK_ENTITY_LABEL) --> ts_el_6_entity_labels[ts_el_6_entity_labels]
SINK_ENTITY_LABEL_PUBLIC_COMMUNITY(SINK_ENTITY_LABEL_PUBLIC_COMMUNITY) --> ts_el_6_entity_labels_public_community[ts_el_6_entity_labels_public_community]
SINK_ENTITY_LABEL_PUBLIC_PROJECT(SINK_ENTITY_LABEL_PUBLIC_PROJECT) --> ts_el_6_entity_labels_public_project[ts_el_6_entity_labels_public_project]
SINK_ENTITY_LABEL_TOOLBOX_COMMUNITY(SINK_ENTITY_LABEL_TOOLBOX_COMMUNITY) --> ts_el_6_entity_labels_toolbox_community[ts_el_6_entity_labels_toolbox_community]
SINK_ENTITY_LANG_LABEL_PUBLIC_COMMUNITY(SINK_ENTITY_LANG_LABEL_PUBLIC_COMMUNITY) --> ts_el_6_entity_language_labels_public_community[ts_el_6_entity_language_labels_public_community]
SINK_ENTITY_LANG_LABEL_TOOLBOX_COMMUNITY(SINK_ENTITY_LANG_LABEL_TOOLBOX_COMMUNITY) --> ts_el_6_entity_language_labels_toolbox_community[ts_el_6_entity_language_labels_toolbox_community]
SINK_LABEL_EDGE_BY_SOURCE(SINK_LABEL_EDGE_BY_SOURCE) --> ts_el_6_label_edge_by_source[ts_el_6_label_edge_by_source]
SINK_LABEL_EDGE_BY_TARGET(SINK_LABEL_EDGE_BY_TARGET) --> ts_el_6_label_edge_by_target[ts_el_6_label_edge_by_target]
ts.projects.entity_label_config[ts.projects.entity_label_config] --> SOURCE_LABEL_CONFIG(SOURCE_LABEL_CONFIG)
SINK_LABEL_CONFIG_BY_PROJECT_CLASS_KEY(SINK_LABEL_CONFIG_BY_PROJECT_CLASS_KEY) --> ts_el_6_label_config_by_project_class_key[ts_el_6_label_config_by_project_class_key]
ts_el_6_label_config_by_project_class_key[ts_el_6_label_config_by_project_class_key] --> SOURCE_LABEL_CONFIG_BY_CLASS_KEY(SOURCE_LABEL_CONFIG_BY_CLASS_KEY)
...
ts_el_6_label_edge_by_source
ts_p_items_6_toolbox_project_edges
ts_el_6_entity_labels
ts_el_6_label_edge_by_target
ts.projects.entity_label_config
ts_el_6_label_config_by_project_class_key
ts_el_6_entity_labels_toolbox_project
ts_el_6_label_edges_toolbox_community_by_source
ts_el_6_entity_labels
ts_el_6_entity_labels_public_community
ts_el_6_entity_labels_public_project
ts_el_6_entity_labels_toolbox_community
ts_el_6_entity_language_labels_public_community
ts_el_6_entity_language_labels_toolbox_community
ts_el_6_label_edge_by_source
ts_el_6_label_edge_by_target
ts_el_6_label_config_by_project_class_key
label-edge-sort-key-store
