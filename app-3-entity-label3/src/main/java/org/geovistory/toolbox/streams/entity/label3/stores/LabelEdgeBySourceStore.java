...
/**
 * Store for label edges partitioned by source entity id
 * with key: {fk_source}_{fk_project}_{...}
 * with val: LabelEdge
 */
@ApplicationScoped
public class LabelEdgeBySourceStore extends AbstractStore<String, LabelEdge> {
    public static final String NAME = "label-edge-by-source-store";
    @Inject
