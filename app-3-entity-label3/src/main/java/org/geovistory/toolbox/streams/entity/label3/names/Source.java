...
public class Source {
    ...
    public static final String LABEL_CONFIG_BY_CLASS_KEY = "SOURCE_LABEL_CONFIG_BY_CLASS_KEY";
    ...
    public static final String LABEL_EDGE_BY_TARGET = "SOURCE_LABEL_EDGE_BY_TARGET";
    public static final String LABEL = "SOURCE_LABEL";
