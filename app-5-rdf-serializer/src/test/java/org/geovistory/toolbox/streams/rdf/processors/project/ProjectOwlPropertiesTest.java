...
class ProjectOwlPropertiesTest {
    ...
    void setup() {
        ...
        var projectOwlProperties = new ProjectOwlClass(avroSerdes, registerInputTopic, outputTopicNames);
    ...
    void testOutputIsNotEmpty() {
        ...
        var vStLit = ProjectStatementValue.newBuilder()
                ...
                .setDeleted$1(false)
                .build();
        projectStatementWithEntityTopic.pipeInput(kStLit, vStLit);
        ...
        var vStEnt = ProjectStatementValue.newBuilder()
                ...
                .setDeleted$1(false)
                .build();
        projectStatementWithLiteralTopic.pipeInput(kStEnt, vStEnt);
