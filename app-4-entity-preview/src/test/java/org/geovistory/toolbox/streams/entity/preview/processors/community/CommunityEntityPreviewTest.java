...
class CommunityEntityPreviewTest {
    ...
    void setup() {
        ...
        Topology topology = CommunityEntityPreview.buildStandalone(new StreamsBuilder(), nameSupplement);
