package org.geovistory.toolbox.streams.entity.label2.partitioner;
...
public class CustomPartitionerTest {
    ...
    public void setUp() {
        ...
        customPartitioner = new CustomPartitioner<String, EdgeValue, ProjectEntityKey>(as, (kv) -> createProjectEntityKeyOfSource(kv.value));
    }
    ...
    public void testPartitioner() {
        ...
        for (Object[] pair : pairs) {
            ...
            var k = createProjectEntityKey(pid, eid);
