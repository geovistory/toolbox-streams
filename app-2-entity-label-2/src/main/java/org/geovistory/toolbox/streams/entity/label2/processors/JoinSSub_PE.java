...
import org.geovistory.toolbox.streams.entity.label2.stores.SSubStore;

import static org.geovistory.toolbox.streams.entity.label2.lib.Fn.createStatementWithSubValue;
...
public class JoinSSub_PE implements Processor<ProjectEntityKey, StatementValue, ProjectEntityKey, StatementWithSubValue> {
    ...
    public void process(Record<ProjectEntityKey, StatementValue> record) {
        ...
        var newJoinVal = createStatementWithSubValue(record.value(), pe);
